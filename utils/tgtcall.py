...
def request(prompt, model='meta-llama/Llama-3-8b-chat-hf', api_key=None, system_message=None, prev_msgs=[], max_retries=3, retry_delay=60, try_count=0, max_tokens=4096, temperature=0, seed=None, track_usage=False):
